  ...
  return (
    <Modal open={open} onClose={onClose} title={t("about.title")}>
      <div className="flex flex-col items-center text-center py-2 space-y-5">
        ...
        {/* Divider */}
        <div
          className="w-full h-px" style={{ background: "var(--border-subtle)" }}
        />
        ...
        <div className="flex flex-wrap items-center justify-center gap-2">
          <a
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all hover:bg-accent text-fg-secondary"
          >
